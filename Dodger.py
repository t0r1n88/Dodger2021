...
if __name__ == '__main__':
    ...
    btn_create_files_contract = Button(tab_create_doc, text='4) Создать документы', font=('Arial Bold', 20),
                                       command=generate_docs
                                       )
    btn_create_files_contract.grid(column=0, row=5, padx=10, pady=10)
